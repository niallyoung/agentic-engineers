...
```
/security-semantic-scan service_path=/home/user/git/ers/{example-service}
...
```bash
# Key files to trace
find /home/user/git/ers/{example-service} -name "*.go" | xargs grep -l "Claims\|scope\|putItem\|PutItem"
```
