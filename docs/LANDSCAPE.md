...
| 2 | agentskills.io conformance audit + badge | 32 tools read SKILL.md; conformance = free portability | S | `src/skills/` | ✓ 2026-08-14: All skills conformant to agentskills.io spec (7 at audit time; `self-healing-review` added 2026-08-15, bringing the roster to 8) |
