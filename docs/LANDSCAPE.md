...
| 3 | AGENTS.md v1.0 readiness | AAIF stable spec + validation tooling 2026 roadmap; CI step stub | S-M | `renderer/`, `.github/workflows/ci.yml` | ✓ 2026-08-14: v1.0/validator confirmed unreleased (no agentsmd/agents.md GitHub release; no primary AAIF roadmap page found — see docs/RENDERING.md); nested-precedence clobber bug found live-tested and fixed in claude/opencode/codex renderers; non-blocking CI probe stub added |
