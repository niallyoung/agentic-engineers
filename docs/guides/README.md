...
This directory holds practical how-to guides. For the canonical protocol,
architecture, and role reference, start at [docs/INDEX.md](../INDEX.md) or
[src/AGENTS.md](../../src/AGENTS.md) instead.
