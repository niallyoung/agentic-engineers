...
| claude-sonnet-5 | Anthropic | $0.003/1K | $0.015/1K |
| claude-opus-5 | Anthropic | $0.005/1K | $0.025/1K |
...
not serve fable-5; it is only used when explicitly requested for defensive analysis.
