...
/quality-gate-orchestration $WORKSPACE_ROOT/{example-service} --deployment-target prod

# Faster check (skip expensive E2E)
/quality-gate-orchestration $WORKSPACE_ROOT/{example-service} --skip-e2e

# With state migration validation
/quality-gate-orchestration $WORKSPACE_ROOT/{example-service} --deployment-target prod --validate-migrations

# JSON output for CI/CD
/quality-gate-orchestration $WORKSPACE_ROOT/{example-service} --json --output-dir ./quality-reports/
```
...
```json
{
  "service_path": "$WORKSPACE_ROOT/{example-service}",
...
```json
{
  ...
  "report_location": "$WORKSPACE_ROOT/quality-reports/{example-service}/2026-04-28-08-15/report.json"
}
```
...
```bash
$ /quality-gate-orchestration $WORKSPACE_ROOT/{example-service} --deployment-target prod --json
...
Report saved: $WORKSPACE_ROOT/quality-reports/{example-service}/2026-04-28-08-15/report.json
```
