...
2. Run `python3 scripts/version-manager/update-changelog.py --dry-run` to preview
3. Push to main (pre-commit hook updates CHANGELOG)
4. CI/CD creates git tag automatically
