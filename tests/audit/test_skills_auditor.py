...
class TestDimensionScore:
    ...
    def test_create_dimension_score(self, ci_safe_skills_path) -> None:
    ...
    def test_dimension_score_with_evidence(self, ci_safe_skills_path) -> None:
    ...
    def test_dimension_score_validation_too_low(self, ci_safe_skills_path) -> None:
        """Test that dimension score rejects values below 1."""
        with pytest.raises(ValueError, match="1-10"):
            DimensionScore(value=0)

    def test_dimension_score_validation_too_high(self, ci_safe_skills_path) -> None:
        """Test that dimension score rejects values above 10."""
        with pytest.raises(ValueError, match="1-10"):
            DimensionScore(value=11)

    def test_dimension_score_edge_values(self, ci_safe_skills_path) -> None:
...
class TestSkillScorecard:
    ...
    def test_create_basic_scorecard(self, ci_safe_skills_path) -> None:
    ...
    def test_scorecard_overall_score_default(self, ci_safe_skills_path) -> None:
    ...
    def test_scorecard_overall_score_mixed(self, ci_safe_skills_path) -> None:
    ...
    def test_scorecard_overall_score_perfect(self, ci_safe_skills_path) -> None:
    ...
    def test_scorecard_dimension_scores_dict(self, ci_safe_skills_path) -> None:
...
class TestSkillDiscovery:
    ...
    def test_skill_discovery_initialization(self, ci_safe_skills_path) -> None:
    ...
    def test_skill_discovery_invalid_path(self, ci_safe_skills_path) -> None:
    ...
    def test_discover_skills(self, ci_safe_skills_path) -> None:
    ...
    def test_discover_skills_returns_paths(self, ci_safe_skills_path) -> None:
    ...
    def test_load_metadata_from_skill(self, ci_safe_skills_path) -> None:
    ...
    def test_count_files(self, ci_safe_skills_path) -> None:
    ...
    def test_count_lines(self, ci_safe_skills_path) -> None:
...
class TestDimensionEvaluator:
    ...
    def test_evaluator_initialization(self, ci_safe_skills_path) -> None:
        """Test evaluator initialization."""
        evaluator = DimensionEvaluator()
        assert evaluator is not None
        assert len(evaluator.DIMENSION_RUBRIC) == 6

    def test_evaluate_value_returns_score(self, ci_safe_skills_path) -> None:
    ...
    def test_evaluate_usage_returns_score(self, ci_safe_skills_path) -> None:
    ...
    def test_evaluate_maintenance_returns_score(self, ci_safe_skills_path) -> None:
    ...
    def test_evaluate_tests_returns_score(self, ci_safe_skills_path) -> None:
    ...
    def test_evaluate_docs_returns_score(self, ci_safe_skills_path) -> None:
    ...
    def test_evaluate_quality_returns_score(self, ci_safe_skills_path) -> None:
    ...
    def test_dimension_rubric_completeness(self, ci_safe_skills_path) -> None:
...
class TestSkillsAuditor:
    ...
    def test_auditor_initialization(self, ci_safe_skills_path) -> None:
    ...
    def test_audit_skill(self, ci_safe_skills_path) -> None:
    ...
    def test_audit_all_skills(self, ci_safe_skills_path) -> None:
    ...
    def test_get_summary_statistics(self, ci_safe_skills_path) -> None:
    ...
    def test_dimension_averages_all_present(self, ci_safe_skills_path) -> None:
    ...
    def test_category_breakdown_structure(self, ci_safe_skills_path) -> None:
    ...
    def test_audit_skill_creates_recommendations(self, ci_safe_skills_path) -> None:
    ...
    def test_category_assignment_based_on_score(self, ci_safe_skills_path) -> None:
...
class TestIntegration:
    ...
    def test_full_audit_workflow(self, ci_safe_skills_path) -> None:
    ...
    def test_audit_maintains_consistency(self, ci_safe_skills_path) -> None:
    ...
    def test_audit_identifies_weak_skills(self, ci_safe_skills_path) -> None:
