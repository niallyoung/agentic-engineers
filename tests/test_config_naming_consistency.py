...
# Full-version names carry a numeric version suffix. Three accepted shapes:
#   claude-<variant>-<major>.<minor>   e.g. claude-haiku-4.5
#   claude-opus-<n>                    e.g. claude-opus-5 (single-part)
#   claude-sonnet-<n>                  e.g. claude-sonnet-5 (single-part)
#   claude-fable-<n>                   e.g. claude-fable-5 (single-part)
