...
context:
  ...
  - Service path: $WORKSPACE_ROOT/{example-service}
...
output:
  ...
  actions:
    - type: archive
      ...
      destination: "~/.claude/plans/archive/phase-5-quality-gates-2026-04-28.md"
      status: success
    - type: delete
...
- Create `$WORKSPACE_ROOT/agentic-engineers/skills/{agent-name}.md` for each
