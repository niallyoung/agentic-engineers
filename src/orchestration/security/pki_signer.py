"""
PKI Signing — Cryptographic signature generation and verification for protocol payloads.

Ensures DELEGATE and HANDBACK blocks are cryptographically signed and haven't been
